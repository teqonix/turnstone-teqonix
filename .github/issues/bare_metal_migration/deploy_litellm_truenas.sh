...
ExecStartPre=-/bin/sh -c 'nohup ${VENV_DIR}/bin/python3 ${LITELLM_DIR}/unified_proxy.py > /var/log/unified_proxy.log 2>&1 &'
...
nohup ${VENV_DIR}/bin/python3 ${LITELLM_DIR}/unified_proxy.py > /var/log/unified_proxy.log 2>&1 &
